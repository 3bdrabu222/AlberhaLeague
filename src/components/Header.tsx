    ...
    <header className="sticky top-0 z-50 bg-white dark:bg-dark-card shadow-md border-b border-gray-200 dark:border-gray-800">
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          {/* Logo */}
          <Link href="/" className={`flex items-center ${language === 'ar' ? 'space-x-reverse' : ''} space-x-3`}>
            <div className="w-10 h-10 bg-purple-600 rounded-full flex items-center justify-center font-bold text-white text-xl">
              {language === 'ar' ? 'دب' : 'FA'}
            </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-2 rounded-lg bg-purple-600 hover:bg-purple-700 text-white font-semibold transition-colors text-sm"
